package demo.seriousface.com.imagepicker.View;
...
public class ImageCycleView extends LinearLayout {
	 ...
	 */
	public void setImageResources(ArrayList<String> imageUrlList ,ImageCycleViewListener imageCycleViewListener , int position)
	{
		// 清除
		...
		mAdvPager.setCurrentItem(position , true);
	}
